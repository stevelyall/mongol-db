...
PYTHON=/home/mci/python/bin/python CC=/opt/mongoldbtoolchain/bin/gcc CXX=/opt/mongoldbtoolchain/bin/g++ CFLAGS=-m64 CCFLAGS=-m64 LINKFLAGS=-m64 -static-libstdc++ -static-libgcc OBJCOPY=/opt/mongoldbtoolchain/bin/objcopy ./configure -without-intl-api --enable-posix-nspr-emulation --disable-ion --disable-trace-logging
