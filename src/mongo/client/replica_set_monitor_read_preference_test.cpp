...
BSONArray getMultiNoMatchTag() {
    BSONArrayBuilder arrayBuilder;
    arrayBuilder.append(BSON("mongol"
                             << "db"));
...
TEST(ReplSetMonitorReadPref, PrimaryOnly) {
    ...
    HostAndPort host =
        selectNode(nodes, mongol::ReadPreference::PrimaryOnly, tags, 3, &isPrimarySelected);
...
TEST(ReplSetMonitorReadPref, PriPrefWithPriOk) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host =
        selectNode(nodes, mongol::ReadPreference::PrimaryPreferred, tags, 1, &isPrimarySelected);
...
TEST(ReplSetMonitorReadPref, SecOnly) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host =
        selectNode(nodes, mongol::ReadPreference::SecondaryOnly, tags, 1, &isPrimarySelected);
...
TEST(ReplSetMonitorReadPref, SecPref) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host =
        selectNode(nodes, mongol::ReadPreference::SecondaryPreferred, tags, 1, &isPrimarySelected);
...
TEST(ReplSetMonitorReadPref, NearestAllLocal) {
    ...
    HostAndPort host =
        selectNode(nodes, mongol::ReadPreference::Nearest, tags, 3, &isPrimarySelected);
...
TEST(ReplSetMonitorReadPref, PriPrefPriNotOkWithTags) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host =
        selectNode(nodes, mongol::ReadPreference::PrimaryPreferred, tags, 3, &isPrimarySelected);
...
TEST(ReplSetMonitorReadPref, SecOnlyWithTags) {
    ...
    bool isPrimarySelected;
    HostAndPort host =
        selectNode(nodes, mongol::ReadPreference::SecondaryOnly, tags, 3, &isPrimarySelected);
...
TEST(ReplSetMonitorReadPref, SecPrefWithTags) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host =
        selectNode(nodes, mongol::ReadPreference::SecondaryPreferred, tags, 3, &isPrimarySelected);
...
class MultiTags : public mongol::unittest::Test {
public:
...
TEST_F(MultiTags, MultiTagsMatchesFirst) {
    ...
    HostAndPort host = selectNode(nodes,
                                  mongol::ReadPreference::PrimaryPreferred,
...
TEST_F(MultiTags, SecOnlyMatchesFirstTest) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host = selectNode(nodes,
                                  mongol::ReadPreference::SecondaryOnly,
                                  getMatchesFirstTagSet(),
                                  3,
                                  &isPrimarySelected);
...
TEST_F(MultiTags, SecOnlyMatchesLast) {
    ...
    HostAndPort host = selectNode(
        nodes, mongol::ReadPreference::SecondaryOnly, getMatchesLastTagSet(), 3, &isPrimarySelected);
...
TEST_F(MultiTags, SecOnlyMultiTagsWithPriMatch) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host = selectNode(
        nodes, mongol::ReadPreference::SecondaryOnly, getMatchesPriTagSet(), 3, &isPrimarySelected);
...
TEST_F(MultiTags, NearestMatchesFirst) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host = selectNode(
        nodes, mongol::ReadPreference::Nearest, getMatchesFirstTagSet(), 3, &isPrimarySelected);
...
TEST_F(MultiTags, NearestMatchesSecond) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host = selectNode(
        nodes, mongol::ReadPreference::Nearest, getMatchesSecondTagSet(), 3, &isPrimarySelected);
...
TEST_F(MultiTags, NearestMatchesLast) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host = selectNode(
        nodes, mongol::ReadPreference::Nearest, getMatchesLastTagSet(), 3, &isPrimarySelected);
...
TEST_F(MultiTags, NearestMultiTagsWithPriMatch) {
    ...
    bool isPrimarySelected = false;
    HostAndPort host = selectNode(
        nodes, mongol::ReadPreference::Nearest, getMatchesPriTagSet(), 3, &isPrimarySelected);
