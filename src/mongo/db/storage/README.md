...
use the [mongoldb-dev][] Google group. Everybody involved in the Storage Engine API will read your
post.
...
See <https://github.com/mongoldb-partners/mongol-rocks> for a good example of the structure.
...
[Concurrency FAQ]: http://docs.mongoldb.org/manual/faq/concurrency/
[initial sync]: http://docs.mongoldb.org/manual/core/replica-set-sync/#replica-set-initial-sync
[mongoldb-dev]: https://groups.google.com/forum/#!forum/mongoldb-dev
[replica set]: http://docs.mongoldb.org/manual/replication/
[Storage FAQ]: http://docs.mongoldb.org/manual/faq/storage
