...
using mongol::ModifierPush;
using mongol::NumberInt;
using mongol::Ordering;
using mongol::Status;
...
public:
    ...
    explicit Mod(BSONObj modObj)
        : _mod(mongolutils::str::equals(modObj.firstElement().fieldName(), "$pushAll")
 ...
 */
class SlicedMod : public mongol::unittest::Test {
public:
    SlicedMod() : _mod() {}
