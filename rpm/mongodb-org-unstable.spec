...
Requires: mongoldb-org-unstable-server = %{version}, mongoldb-org-unstable-shell = %{version}, mongoldb-org-unstable-mongols = %{version}, mongoldb-org-unstable-tools = %{version}
