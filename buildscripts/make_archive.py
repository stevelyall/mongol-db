...
src/mongol/foo.cpp and build/linux2/normal/buildinfo.cpp can get put into the same
directory in the archive, perhaps mongoldb-2.0.2/src/mongol.
...
For a detailed usage example, see src/SConscript.client or src/mongol/SConscript.
'''
...
def make_tar_archive(opts):
    ...
    e.g. for an input file named "a/mongol/build/DISTSRC", and an
    existing transformation {"a/mongol/build": "release"}, the input
