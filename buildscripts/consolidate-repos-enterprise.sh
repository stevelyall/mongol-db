...
# Examples:
#
# /var/www-enterprise/repo.consolidated/yum/redhat/5/mongoldb-enterprise/unstable -> 2.5
# /var/www-enterprise/repo.consolidated/yum/redhat/6/mongoldb-enterprise/unstable -> 2.5
# /var/www-enterprise/repo.consolidated/apt/ubuntu/dists/precise/mongoldb-enterprise/unstable -> 2.5
# /var/www-enterprise/repo.consolidated/apt/debian/dists/wheezy/mongoldb-enterprise/unstable -> 2.5
#
