...
var coll = mongols.getCollection( jsTestName() + ".foo" )

st.shardColl( coll, { _id : 1, i : 1 }, { _id : ObjectId(), i : 1 } )

printjson( mongols.getDB("config").chunks.find().toArray() )
...
var coll = mongols.getCollection( "" + coll + "2" )
for( var i = 0; i < 10; i++ ){
...
var coll = mongols.getCollection( "" + coll + "3" )
for( var i = 0; i < 10; i++ ){
    // TODO : does not check weird cases like [ i, i ]
